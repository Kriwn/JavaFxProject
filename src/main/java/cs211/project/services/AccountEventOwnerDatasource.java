...
public class AccountEventOwnerDatasource implements Datasource<HashMap<Integer, ArrayList<Integer>>> {

        private String directoryName;
        private String fileName;

        public AccountEventOwnerDatasource(String directoryName, String fileName){
